SpectrumSimilarity <- function(spec.top, spec.bottom, t = 0.01, b = 0, top.label = NULL, 
                               bottom.label = NULL, xlim =  c(50, 1200)) {
  
  #only keep mz and intensity column					
  keeps <- c("mz", "intensity")
  spec.top = spec.top[keeps]
  spec.bottom = spec.bottom[keeps]
...
SpectrumSimilarityPlotting <- function(spec.top, spec.bottom, t = 0.01, b = 0, top.label = NULL, 
                               bottom.label = NULL, xlim =  c(50, 1200)) {
	#only keep mz and intensity column					
  keeps <- c("mz", "intensity")
  spec.top = spec.top[keeps]
...
# SpectrumSimilarityPlotting(df1, df2, xlim=c(129, 1538))


# SpectrumSimilarityPlotting(df1, df1, xlim =  c(129.1023406982422, 1168.49365234375))
